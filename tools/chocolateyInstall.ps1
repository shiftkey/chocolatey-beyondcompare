...
if ($LCID -in $german)
{
    $url = 'http://www.scootersoftware.com/BCompare-de-4.1.0.20575.exe'
}
elseif ($LCID -in $french)
{
    $url = 'http://www.scootersoftware.com/BCompare-fr-4.1.0.20575.exe'
}
else
{
    $url = 'http://www.scootersoftware.com/BCompare-4.1.0.20575.exe'
}
