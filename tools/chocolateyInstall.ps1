...
if ($LCID -in $german)
{
    $url = 'http://www.scootersoftware.com/BCompare-de-4.0.7.19761.exe'
}
elseif ($LCID -in $french)
{
    $url = 'http://www.scootersoftware.com/BCompare-fr-4.0.7.19761.exe'
}
else
{
    $url = 'http://www.scootersoftware.com/BCompare-4.0.7.19761.exe'
}
